  ...
  return (
    <div className="flex flex-col items-center w-full gap-4">
      <div className="w-full flex gap-4" style={{ height: 500 }}>
        ...
        <div 
          className="w-1/6 bg-white border-2 border-gray-200 overflow-y-auto rounded-2xl"
        ...
        <div className="flex-1 overflow-y-auto rounded-2xl bg-white">
          {selectedCategory ? (
            ...
            <div className="h-full p-12 flex flex-col items-center justify-center rounded-2xl border-2 border-gray-200">
